export const MINTING_CONTRACT_ABI = [
    ...
    inputs: [
      { internalType: "address[]", name: "_assets", type: "address[]" },
      {
        components: [
          ...
          { internalType: "uint128", name: "maxMintPerBlock", type: "uint128" },
          {
      ...
      { internalType: "address[]", name: "_custodians", type: "address[]" },
      { internalType: "address", name: "_admin", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "BenefactorNotWhitelisted", type: "error" },
  { inputs: [], name: "BeneficiaryNotApproved", type: "error" },
  { inputs: [], name: "DelegationNotInitiated", type: "error" },
  { inputs: [], name: "GlobalMaxMintPerBlockExceeded", type: "error" },
  { inputs: [], name: "GlobalMaxRedeemPerBlockExceeded", type: "error" },
  { inputs: [], name: "InvalidAddress", type: "error" },
  { inputs: [], name: "InvalidAdminChange", type: "error" },
  { inputs: [], name: "InvalidAmount", type: "error" },
  { inputs: [], name: "InvalidAssetAddress", type: "error" },
  { inputs: [], name: "InvalidBenefactorAddress", type: "error" },
  { inputs: [], name: "InvalidBeneficiaryAddress", type: "error" },
  { inputs: [], name: "InvalidCustodianAddress", type: "error" },
  { inputs: [], name: "InvalidEIP1271Signature", type: "error" },
  { inputs: [], name: "InvalidEIP712Signature", type: "error" },
  ...
  { inputs: [], name: "UnknownSignatureType", type: "error" },
  ...
  {
    inputs: [{ internalType: "address", name: "custodian", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "address", name: "_delegatedBy", type: "address" },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint120", name: "expiry", type: "uint120" },
  ...
  {
    inputs: [
      { internalType: "address", name: "collateralManager", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_removedSigner", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "_delegateTo", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "uint128", name: "_maxMintPerBlock", type: "uint128" },
      { internalType: "address", name: "asset", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint128", name: "_maxRedeemPerBlock", type: "uint128" },
      { internalType: "address", name: "asset", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint128", name: "_stablesDeltaLimit", type: "uint128" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bool", name: "isActive", type: "bool" },
      { internalType: "uint128", name: "maxMintPerBlock", type: "uint128" },
      { internalType: "uint128", name: "maxRedeemPerBlock", type: "uint128" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    name: "totalPerBlock",
    outputs: [
      { internalType: "uint128", name: "mintedPerBlock", type: "uint128" },
      { internalType: "uint128", name: "redeemedPerBlock", type: "uint128" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "verifyOrder",
    outputs: [
      { internalType: "bytes32", name: "taker_order_hash", type: "bytes32" },
    ],
    stateMutability: "view",
    type: "function",
  },
