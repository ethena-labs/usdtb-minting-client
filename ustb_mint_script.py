...
if __name__ == "__main__":
    ...
    with open('ustb_token_abi.json') as f:
        usde_abi = json.load(f)

    w3 = Web3(Web3.HTTPProvider(WEB3_URL))

    ustb_minting_contract = w3.eth.contract(address=USTB_MINTING_ADDRESS, abi=mint_abi)
    usde_contract = w3.eth.contract(address=USTB_TOKEN_ADDRESS, abi=usde_abi)

    usdc_address = '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'
    buidl_address = '0x7712c34205737192402172409a8F7ccef8aA2AEc'

    type_ = 'ALGO'
    rfq_url = f'{ustb_public_url}rfq?pair=USDC/UStb&type_={type_}&side=MINT&size=25'
    ...
    order_tuple = (
        ...
        mint_order['ustb_amount']  # uint256 ustb_amount, use exact value provided in RFQ
    )
    ...
    url = f'''{ustb_public_url}order?signature={signature_hex}'''
